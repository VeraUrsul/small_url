...
Файл `Small_url.postman_collection.json` содержит postman-коллекцию - набор заранее подготовленных запросов для проверки работы API.
...
Загрузите файл `Small_url.postman_collection.json` в Postman.
